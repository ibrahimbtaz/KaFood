...
class CateringInfo extends StatelessWidget {
  ...
  const CateringInfo(this.catering);
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('${catering.title} ${catering.subtitle}',
          ...
          RichText(
            text: TextSpan(children: [
              TextSpan(
                  text:
                      'Paket Nasi Tumpeng, Paket Nasi Tumpeng ini terdiri dari berbagai macam Size yang didalam nya terdapat\nmacam-macam Lauk-Pauk yang sangat Lezat dan Bergizi cocok untuk acara Festival, Pernikahan, Tahun Baru dll.\n',
                  style: TextStyle(
                      color: Colors.black26.withOpacity(0.7), height: 1.5)),
              TextSpan(
